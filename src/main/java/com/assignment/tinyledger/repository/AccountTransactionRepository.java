...
/**
 * Interface for transaction data repository of all the transactionTypes
 *
 * @author Sreelekha
 */
...
public interface AccountTransactionRepository {
     ...
     * @param transaction   including details transactionType(DEPOSIT OR WITHDRAWAL),amount,transaction details
     ...
     */
    void createTransaction(String accountNumber, Transaction transaction);
